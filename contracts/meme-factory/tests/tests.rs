use gstd::ActorId;
use gtest::{Program, System, Log, TestError};
use io::*;
...
pub const MEME_ADDRESS: ActorId = ActorId::new([240, 35, 217, 33, 79, 57, 144, 77, 203, 216, 17, 51, 38, 135, 252, 73, 206, 23, 79, 12, 248, 73, 207, 171, 26, 91, 216, 6, 202, 243, 156, 250]);
    
#[test]
    fn init_meme_factory() {
    let system = System::new();
    let meme_code_id = system.submit_code("../target/wasm32-unknown-unknown/release/fungible_token.opt.wasm");
