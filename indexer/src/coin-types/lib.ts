...
export class Admin {
  ...
  public changeDescription(new_description: string): TransactionBuilder<null> {
    ...
    return new TransactionBuilder<null>(
      ...
      this._program.registry,
      'send_message',
      ['Admin', 'ChangeDescription', new_description],
  ...
  public changeExternalLinks(new_external_links: ExternalLinks): TransactionBuilder<null> {
    if (!this._program.programId) throw new Error('Program ID is not set');
    return new TransactionBuilder<null>(
      this._program.api,
      this._program.registry,
      'send_message',
      ['Admin', 'ChangeExternalLinks', new_external_links],
  ...
  public changeImageLink(new_image_link: string): TransactionBuilder<null> {
    ...
    return new TransactionBuilder<null>(
      ...
      this._program.registry,
      'send_message',
      ['Admin', 'ChangeImageLink', new_image_link],
      '(String, String, String)',
      'Null',
      this._program.programId
    );
  ...
  public transferToUsers(to: Array<string>, value: number | string): TransactionBuilder<boolean> {
    if (!this._program.programId) throw new Error('Program ID is not set');
    return new TransactionBuilder<boolean>(
      this._program.api,
      this._program.registry,
  ...
  public async allowances(skip: number, take: number, originAddress: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[[string, string], number | string]>> {
  ...
  public async balances(skip: number, take: number, originAddress: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<Array<[string, number | string]>> {
  ...
  public async mapsData(originAddress: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<[[number, number], [number, number]]> {
  ...
  public async maxSupply(originAddress: string, value?: number | string | bigint, atBlock?: `0x${string}`): Promise<bigint> {
  ...
  public subscribeToTransferredToUsersEvent(callback: (data: { from: string; to: Array<string>; value: number | string }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      if (!message.source.eq(this._program.programId) || !message.destination.eq(ZERO_ADDRESS)) {
        return;
      }
      ...
      if (getServiceNamePrefix(payload) === 'Admin' && getFnNamePrefix(payload) === 'TransferredToUsers') {
        callback(this._program.registry.createType('(String, String, {"from":"[u8;32]","to":"Vec<[u8;32]>","value":"U256"})', message.payload)[2].toJSON() as { from: string; to: Array<string>; value: number | string });
      }
    });
  }

  public subscribeToDescriptionChangedEvent(callback: (data: { new_description: string }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      if (!message.source.eq(this._program.programId) || !message.destination.eq(ZERO_ADDRESS)) {
        return;
      }
      ...
      const payload = message.payload.toHex();
      if (getServiceNamePrefix(payload) === 'Admin' && getFnNamePrefix(payload) === 'DescriptionChanged') {
        callback(this._program.registry.createType('(String, String, {"new_description":"String"})', message.payload)[2].toJSON() as { new_description: string });
      }
    });
  }

  public subscribeToImageLinkChangedEvent(callback: (data: { new_image_link: string }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      if (!message.source.eq(this._program.programId) || !message.destination.eq(ZERO_ADDRESS)) {
        return;
      }
      ...
      const payload = message.payload.toHex();
      if (getServiceNamePrefix(payload) === 'Admin' && getFnNamePrefix(payload) === 'ImageLinkChanged') {
        callback(this._program.registry.createType('(String, String, {"new_image_link":"String"})', message.payload)[2].toJSON() as { new_image_link: string });
      }
    });
  }

  public subscribeToExternalLinksChangedEvent(callback: (data: { new_external_links: ExternalLinks }) => void | Promise<void>): Promise<() => void> {
    return this._program.api.gearEvents.subscribeToGearEvent('UserMessageSent', ({ data: { message } }) => {;
      if (!message.source.eq(this._program.programId) || !message.destination.eq(ZERO_ADDRESS)) {
        return;
      }
      ...
      const payload = message.payload.toHex();
      if (getServiceNamePrefix(payload) === 'Admin' && getFnNamePrefix(payload) === 'ExternalLinksChanged') {
        callback(this._program.registry.createType('(String, String, {"new_external_links":"ExternalLinks"})', message.payload)[2].toJSON() as { new_external_links: ExternalLinks });
      }
    });
  }
}
