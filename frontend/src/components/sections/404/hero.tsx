		...
		<div className="relative mt-[calc(-1*var(--header-height))] flex min-h-svh grow flex-col pt-[--header-height]">
			<div className="relative z-1 grid grow grid-cols-2 items-center gap-x-30 px-4">
				...
				<div className="px-16 pb-6">
					<h1 className="text-[100px] leading-none text-[#FDFDFD] drop-shadow-[0_6px_0_#242424]">
						404
					</h1>
					<p className="mt-6 font-silkscreen text-[40px]/[1.25] text-[#FDFDFD] drop-shadow-[0_2px_0_#242424]">
						Page not found
					</p>
					<div className="mt-10">
